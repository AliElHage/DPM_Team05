...
public class BlockHunter extends Thread{
	...
	public BlockHunter(Odometer odometer, Navigation nav, UltrasonicPoller USPoller, LightDetector light, EV3LargeRegulatedMotor hookMotorL, EV3LargeRegulatedMotor hookMotorR){
		this.odo = odometer;
		this.nav = nav;
